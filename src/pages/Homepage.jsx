        ...
        <div className="container-fluid p-5">
          ...
          <div className="container mt-5">
            <div className="row">
              <div className="col-12">
                <h2 className="text-center main-title mb-4">
                  Tentang Aplikasi
                </h2>
                <p className="text-muted text-center main-body">
                  EcoRecycle adalah sebuah aplikasi inovatif yang dirancang
                  untuk memfasilitasi
                ...
                <p className="text-muted text-center main-body">
                  Aplikasi ini bertujuan untuk menjembatani kesenjangan dalam
                  sistem pengelolaan
                  <br />
                  sampah nasional di Indonesia, di mana masih terdapat sekitar
                  7.2 juta ton sampah
                  <br /> yang belum terkelola dengan baik berdasarkan data tahun
                  2022 dari Sistem Informasi <br />
                  Pengelolaan Sampah Nasional (SIPSN) Kementerian Lingkungan
          ...
          <div className="container mt-5">
            <div className="row">
              <div className="col-12">
                <h2 className="text-center">
                  Sebaran Fasilitas Lokasi TPA & Bank Sampah yang Telah
                  Terdaftar
                </h2>
                <MapComponent />
              </div>
